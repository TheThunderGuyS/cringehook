 ...
 * Additional usage instructions, details and examples are in the {@link https://github.com/TheThunderGuyS/cringehook/blob/2.0.0/README.md module's readme}.
...
module.exports = async (id, token) => {
    ...
    const supposedlyFunny = new Discord.MessageEmbed() //Generate embed that's actually cringe
        .attachFiles(["https://raw.githubusercontent.com/TheThunderGuyS/cringehook/2.0.0/img/scratch.png", "https://raw.githubusercontent.com/TheThunderGuyS/cringehook/2.0.0/img/jarate.png", "https://raw.githubusercontent.com/TheThunderGuyS/cringehook/2.0.0/img/chungus.png", "https://raw.githubusercontent.com/TheThunderGuyS/cringehook/2.0.0/img/mineblocx.png"]) //Images
